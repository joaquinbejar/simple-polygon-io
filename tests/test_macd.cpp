...
TEST_CASE("OhlcParams Tests", "[macd]") {
    OhlcParams params;
    // Set some values in params
    params.set_date("2023-11-24");
    params.set_adjusted(Adjusted::TRUE);
...
TEST_CASE("OhlcParams Empty Tests", "[macd]") {
...
TEST_CASE("JsonResponse to Queries", "[macd]") {
    json j = R"({
                "queryCount": 3,
                "resultsCount": 3,
                "adjusted": true,
...
TEST_CASE("JsonResponse merge to Queries", "[macd]") {
    json j1 = R"({
                "queryCount": 3,
                "resultsCount": 3,
                "adjusted": true,
